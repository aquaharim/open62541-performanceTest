 ...
 * Generated from C:/upload/open62541/tools/schema/NodeIds.csv with script C:/upload/open62541/tools/generate_nodeid_header.py
 *-------------------------------------------------------*/
 ...
 * following definitions are autogenerated from the ``C:/upload/open62541/tools/schema/NodeIds.csv`` file */
